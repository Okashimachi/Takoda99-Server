...
|---|---|---|
| 0 | SplitAttack | 分散攻撃 |
| 1 | Counter | 直前の攻撃者へ反撃寄り |
| 2 | Finisher | 瀕死を狙う |
| 3 | BadgeHunter | バッジ保有者を狙う |
| 4 | Random（既定） | ランダムな生存者 |
| 5 | Revenge | 自分を攻撃した相手へ |
| 6 | TallPoppy | 強者（高コンボ等）を狙う |
| 7 | Neighbor | 盤面上の近傍 |
| 8 | PileOn | 集中砲火に乗る |
| 9 | PacifistHunter | 攻撃してこない相手を狙う |

> 具体的な選定ロジックはサーバー内部。クライアントは id を送るだけ。
