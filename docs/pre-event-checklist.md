...
| キー | 既定（強/中/弱） | 効き方 |
|---|---|---|
| `bot.tiers[*].msPerKey` | 150 / 200 / 280 | **小さいほど速い＝強い**。主に触るのはこれ。**3つとも同じ向きに動かす** |
...
> 既定値では **200ms/打鍵の人間がちょうど 54位/100**、150ms/打鍵で19位、280ms/打鍵で89位。
> **打鍵が遅い人（400ms/打鍵）は最下位**になるので、参加者が初心者中心なら3つとも上げる。
