...
func TestWireGolden(t *testing.T) {
	...
	cases := []struct {
		...
		{"MatchStart",
			...
			`{"matchId":"m-1","selfPlayerId":"p1","players":[{"playerId":"p1","displayName":"p1","comboValue":0,"dakenStackCount":0,"dakenStackLimit":20,"badgeCount":0,"alive":true}],"initialDaken":{"dakenId":"p1-1","type":"Normal","text":"ねこ","difficultyLevel":0,"timeLimitMs":5000,"issuedAtServerTimeMs":0},"parameters":{"stackLimit":20,"trapTriggerInterval":5,"personalDifficultyStep":20,"difficultyMaxLevel":10}}`},
		...
		{"AttackFailed", AttackFailed{Reason: FailNoTarget}, `{"reason":"NoTarget"}`},
		{"OffsetResolved/nil", OffsetResolved{WarningId: "w-1", OffsetAmount: 28, RemainderDakenCount: 0}, `{"warningId":"w-1","offsetAmount":28,"remainderDakenCount":0}`},
		{"OffsetResolved/counter", OffsetResolved{WarningId: "w-1", OffsetAmount: 28, RemainderDakenCount: 3, CounterAttackWarningId: &counter}, `{"warningId":"w-1","offsetAmount":28,"remainderDakenCount":3,"counterAttackWarningId":"w-9"}`},
		...
		{"PlayerListUpdated",
			...
			`{"players":[{"playerId":"p1","displayName":"p1","comboValue":0,"dakenStackCount":0,"dakenStackLimit":20,"badgeCount":0,"alive":true}],"aliveCount":1}`},
		{"GameOver",
		...
		{"AttackRequest", AttackRequest{ConsumedCombo: 28}, `{"consumedCombo":28}`},
